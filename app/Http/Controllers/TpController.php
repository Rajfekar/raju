...
/*
|--------------------------------------------------------------------------
| Indexing - All functions list  of tp dashboard  dashboard
|--------------------------------------------------------------------------
...
class TpController extends Controller
{
    public function index()
    {
        ...
        return view('tpdash.dash',compact('s'));
    }
    ...
    public function change_pass()
  {
    ...
    return view('tpdash.change_pass', compact('s'));
  }
  ...
  public function qr_code()
  {
    ...
    return view('tpdash.qr_code', compact('s'));
  }
  ...
  public function update_pass(Request $request)
  {
    ...
    $user = User::where('collegeid', '=', $request->collegeid)->first();
    if (Hash::check($request->cpassword, $user->password)) {
      $update = User::where('collegeid', '=', $request->collegeid)->update([
        'password' => $pass,
      ]);
      if ($update) {
