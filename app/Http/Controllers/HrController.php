...
/*
|--------------------------------------------------------------------------
| Indexing - All functions list  of HR dashboard
|--------------------------------------------------------------------------
...
class HrController extends Controller
{
    public function index()
    {
        ...
        return view('hrdash.dash',compact('s'));
    }
    ...
    public function change_pass()
  {
    ...
    return view('hrdash.change_pass', compact('s'));
  }
  ...
  public function qr_code()
  {
    ...
    return view('hrdash.qr_code', compact('s'));
  }
