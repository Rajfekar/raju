...
/*
|--------------------------------------------------------------------------
| Indexing - All functions list  of employee dashboard  dashboard
|--------------------------------------------------------------------------
...
class EmpController extends Controller
{
    public function index()
    {
        ...
        return view('empdash.dash',compact('s'));
    }
    ...
    public function change_pass()
  {
    ...
    return view('empdash.change_pass', compact('s'));
  }
  ...
  public function qr_code()
  {
    ...
    return view('empdash.qr_code', compact('s'));
  }
