            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-3">
                        ...
                        @if(Session::has('sname'))
                         <a href="#">
                                            <img
                                                ...
                                                width="100px"
                                                class="profileimage"
                                                src="{{'storage/students/'. session::get('simage')}}"
                                                alt="img"
                       ...
                       <div style="color:white;" class="textbox3">ID: {{Session::get('slibid')}} </div> <br><br>
                       <div style="color:white;" class="textbox3">Enter {{Session::get('sintime')}} </div> <br><br>
                       <div style="color:white;" class="textbox3">Exit {{Session::get('souttime')}} </div> <br><br>
                       @else
                        <a href="#">
                                            <img
                                                height="100px"
                       ...
                       <div style="color:white;" class="textbox3">  Khemraj Fekar </div> <br><br>
                        <div style="color:white;" class="textbox3">  ID: CS1945  </div> <br><br>
                       <div style="color:white;" class="textbox3"> ENTER 00:00 AM  </div><br><br>
                      <div style="color:white;" class="textbox3">  EXIT  00:00 PM  </div>
