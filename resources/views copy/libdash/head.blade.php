...
<html lang="en">
  <head>
    ...
    <title>RIT Central Library</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="{{url('/rit/libdashboard')}}">Rit Raipur</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img style="height:40px" class="app-sidebar__user-avatar"  src="{{'/storage/students/'. session()->get('image')}}" alt="img" onerror=this.src="{{'/images/profile.jfif'}}">
        ...
        <div>
          <p class="col-md-12">{{session()->get('librarian_name')}}</p>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Attandance</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{url('/rit/libdashboard/attendance/datewise')}}"><i class="icon fa fa-circle-o"></i> Datewise</a></li>
            <li><a class="treeview-item" href="{{url('/rit/libdashboard/attendance')}}"><i class="icon fa fa-circle-o"></i> Allday</a></li>
          </ul>
        </li>
        ...
        <li><a class="app-menu__item active" href="{{url('/rit+raipur+qr+code+login+by+khemraj+fekar+7697477107+cse+301202219077+cs1945')}}"><i class="app-menu__icon fa fa-camera-retro"></i><span class="app-menu__label">Scanner</span></a></li>
