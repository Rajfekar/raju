        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form method="post" action="{{url('/rit/libdashboard/add_member2')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="libid" class="form-control" type="text" placeholder="Enter Library ID" />
                                        @error('libid')
                                        <div style="color:red;">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="animated-radio-button">
                                    ...
                                    <label>
                                        <input value="0" type="radio" name="gender" /><span class="label-text">Male</span>
                                    </label>
                                </div>
                                ...
                                <div class="animated-radio-button">
                                    <label>
                                        <input value="1" type="radio" name="gender" /><span class="label-text">Female</span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
