              ...
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover" id="example2">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$m++}}</td>
                      <td style="text-transform:uppercase;"><a style="text-decoration:none; color:black;" href="{{url('/rit/libdashboard/attendancenow/'.$student->libid)}}">{{$student->libid}}</a></td>
                      <td>
                        <a style="text-decoration: none; color:black;" href="{{'/rit/libdashboard/editmember/'.$student->collegeid}}">
                          <img src="{{'/storage/students/'. $student->image}}" alt="image" onerror=this.src="{{'/images/profile.jfif'}}" height="50px" width="50px" style="border-radius: 50%"></a>
                 </td>
