        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="row create_ngo">
                    <div class="col-md-12">
                        ...
                        <input value="{{session()->get('student_id')}}" name="id" type="hidden" id="ContentPlaceHolder1_txtcurrentpass" class="form-control">
            ...
            @enderror
                    ...
                    <div class="col-md-12 text-center">
                        <input type="submit" name="ctl00$ContentPlaceHolder1$btnchangepass" value="Update Password" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$ContentPlaceHolder1$btnchangepass&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" id="ContentPlaceHolder1_btnchangepass" class="btn btn-primary px-4 my-3 font-weight-bold">
                    </div>
                    <div class="col-md-12 text-center">
