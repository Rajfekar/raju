...
<main class="app-content">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="post" action="{{url('/rit/hrdashboard/change_pass/updatepass/')}}">
                @csrf
            <div class="row create_ngo">
                <div class="col-md-12">
                    <h6>Enter Current Password</h6>
                    <input value="{{session()->get('hr_id')}}" name="id" type="hidden" id="ContentPlaceHolder1_txtcurrentpass" class="form-control">
