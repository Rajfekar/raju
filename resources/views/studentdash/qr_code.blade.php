    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row create_ngo">
                ...
                <div class="col-md-12">
                    <input type="hidden" id="studentqrdata" value="{{session()->get('student_id')}}">
                ...
                <div class="col-md-12 text-center">
                    <input type="button" name="ctl00$ContentPlaceHolder1$btnchangepass" value="Get QR_CODE"
                        onclick="createqr();" id="ContentPlaceHolder1_btnchangepass"
                        class="btn btn-primary px-4 my-3 font-weight-bold">
                </div>
                <div class="col-md-12 text-center">
