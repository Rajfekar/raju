        ...
        <div class="card-body">
            <div class="row create_ngo">
                <div class="col-md-6">
                    ...
                    <input name="ctl00$ContentPlaceHolder1$txt_vtm_first_name" type="text" value="{{$s->name}}" id="ContentPlaceHolder1_txt_vtm_first_name" class="form-control form-control-user" disabled>
