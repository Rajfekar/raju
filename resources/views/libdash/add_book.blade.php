        ...
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form action="{{route('addbook')}}" method="post" enctype="multipart/form-data">
              ...
              <label>Detail:</label><input class="form-control" type="text" name="detail" value="{{old('detail')}}" />
              @error('detail')
              <span style="color:red;" class="alert-danger mt-1 mb-1">{{ $message }}</span>
              @enderror</br>
              <label>Author:</label><input class="form-control" type="text" name="author" value="{{old('author')}}" />
              @error('author')
              <span style="color:red;" class="alert-danger mt-1 mb-1">{{ $message }}</span>
              @enderror</br>
              <label>Publication</label><input class="form-control" type="text" name="publication"
                value="{{old('publication')}}" /> @error('publication')
              <span style="color:red;" class="alert-danger mt-1 mb-1">{{ $message }}</span>
              @enderror</br>
              ...
              <label>Price:</label><input class="form-control" type="number" name="price" value="{{old('price')}}" />
              @error('price')
              <span style="color:red;" class="alert-danger mt-1 mb-1">{{ $message }}</span>
              @enderror</br>
