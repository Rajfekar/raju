...
<body style="background: linear-gradient(black,darkblue);">
    ...
    <main>
        <div class="container">
            ...
            <h2 id="textbox">
                <marquee behavior="alternate" direction="" scrollamount="6">{{Session::get('success')}}</marquee>
            </h2>
            @endif
            @if(Session::has('fail'))
            <input id="alertdanger" type="hidden" value="1" />
            <h2 style="color: red" id="textbox2">
                <marquee behavior="alternate" direction="" scrollamount="6">{{Session::get('fail')}}</marquee>
            </h2>
            @endif
            <div class="row">
                <div class="col-md-3">
                        ...
                        <div class="boxshadow7" id="date">
                            ...
                            <div class="boximg">
                                <div class="imgcontent">
                                    <a href="#"><img height="150px" width="150px" class="profileimage"
                                            src="{{'storage/students/'. session::get('simage')}}" alt="img"
                            ...
                            <div style="color:white;" class="textbox3 textshadow2"> {{Session::get('sname')}} </div>
                            <br><br>
                            <div style="color:white;" class="textbox3 textshadow2">ID: {{Session::get('slibid')}} </div>
                            <br><br>
                            <div style="color:white;" class="textbox3 textshadow2">Enter {{Session::get('sintime')}}
                            </div> <br><br>
                            <div style="color:white;" class="textbox3 textshadow2">Exit {{Session::get('souttime')}}
                            </div> <br><br>

                            @else
                            <div style="color:white;" class="textbox3 textshadow1"> {{Session::get('sname')}} </div>
                            <br><br>
                            <div style="color:white;" class="textbox3 textshadow1">ID: {{Session::get('slibid')}} </div>
                            <br><br>
                            <div style="color:white;" class="textbox3 textshadow1">Enter {{Session::get('sintime')}}
                            </div> <br><br>
                            <div style="color:white;" class="textbox3 textshadow1">Exit {{Session::get('souttime')}}
                            </div> <br><br>

                            @endif

                            @else
                            <a href="#"><img height="150px" width="150px" class="profileimage" src="{{'images/A1.jpg'}}"
                                    alt="img" onerror=this.src="{{'/images/profile.jfif'}}"
                                    style="border-radius: 50%" /></a>
                                ...
                                <table class="table table-bodered table-striped table-hover" id="example6">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#"><img height="35px" width="35px" class="profileimage"
                                                        src="{{'storage/students/'. $b->demo2}}" alt="img"
                                                        onerror=this.src="{{'/images/profile.jfif'}}"
        ...
        <div class="content">
            <div class="left box">
                ...
                <div class="lower">
                    ...
                    <div class="phone"><a href="tel:+917697477107"><i class="fas fa-phone-volume"></i>+917697477107</a>
                    </div>
                    <div class="email"><a href="riteelibrary@gmail.com"><i
                                class="fas fa-envelope"></i>riteelibrary@gmail.com</a></div>
                </div>
            </div>
