...
<main class="app-content">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="post" action="{{url('/rit/tpdashboard/change_pass/updatepass/')}}">
                @csrf
            <div class="row create_ngo">
                <div class="col-md-12">
                    <h6>Enter Current Password</h6>
                    <input value="{{session()->get('tp_id')}}" name="collegeid" type="hidden" id="ContentPlaceHolder1_txtcurrentpass" class="form-control">
